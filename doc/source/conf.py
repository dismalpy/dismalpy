# -*- coding: utf-8 -*-
#
# DismalPy documentation build configuration file. Largely copied from
...
version = re.sub(r'(\d+\.\d+)\.\d+(.*)', r'\1\2', dismalpy.__version__)
version = re.sub(r'(\.dev\d+).*?$', r'\1', version)
# The full version, including alpha/beta/rc tags.
release = dismalpy.__version__
